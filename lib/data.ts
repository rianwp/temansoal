export const mataPelajaran = [
  ...
  {
    nama: 'Biologi',
    subTopik: ['genetika', 'botani', 'reproduksi']
  },
  {
  ...
  {
    nama: 'Komputer dan Teknologi',
    subTopik: ['pemrograman', 'jaringan komputer', 'struktur data']
  },
  {
    nama: 'Prakarya dan Kewirausahaan',
    subTopik: ['pengembangan bisnis', 'manajemen bisnis', 'kewirausahaan']
  }
]
