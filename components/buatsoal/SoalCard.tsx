  ...
  return (
    <Card className="w-full p-4">
      <h2 className="flex flex-row items-center">
        <div className="bg-primary text-sm text-secondary rounded-full flex justify-center items-center h-5 w-5">{urutan}</div>
          ...
          {typeof jawaban === "string" ?
            ...
            <div className="flex flex-row items-start space-x-2">
              ...
              <p className="flex flex-row text-base text-sky-600">
                ...
                <p className="font-semibold">{jawaban.deskripsi}</p>
              </p>
            </div>
          }
          <div className="flex flex-row items-start space-x-2">
