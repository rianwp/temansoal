...
const Hero = () => {
  return (
    <div className="w-full hero-responsive bg-gradient-to-r from-blue-600 via-sky-500 to-emerald-400 -mt-16 pt-16 flex flex-row justify-center md:justify-start items-center p-3 md:px-10">
