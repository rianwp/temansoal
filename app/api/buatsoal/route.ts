...
export const POST = async (req: Request) => {
  ...
  const jawabanPrompt = `gunakan format json ${haveOptions ? `{soal:"soal", pilihan:[(a,b,c,d,e dalam huruf kapital)], jawaban:{(a,b,c,d,e dalam huruf kapital)}, pembahasan: "pembahasan singkat"` : `{soal:"soal", jawaban:"jawaban", pembahasan: "pembahasan singkat"}`}.`
